...
\begin{itemize}   \itemsep 0pt % Slightly reduced spacing for sub-items
	\item Developed AI-driven navigation for warehouse AMRs; reduced manual intervention by 40\%.
	\item Deployed embedded ML for obstacle detection, path planning, and collision avoidance.
	\item Designed multi-robot fleet coordination algorithms optimizing task allocation and traffic flow.
	\item Fused LiDAR, camera, and IMU data for robust SLAM-based localization and mapping.
	\item Architected ROS\,2 nodes for reliable hardware–software communication across the fleet.
	\item Validated controllers in Isaac Sim and PyBullet; generated synthetic datasets for training.
\end{itemize}
