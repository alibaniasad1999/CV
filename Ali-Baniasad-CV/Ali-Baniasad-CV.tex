...
\noindent
 \bf{M.S.}
 \normalfont{Aerospace Engineering} \hfill Sep.\ 2022 -- Sep.\ 2025 \\
...
\begin{itemize} \itemsep -1pt % Reduce space between items
	% Template: duplicate and fill in your details; remove comments when ready
	% \item \textbf{A. BaniAsad}, "[Working paper title]," (in preparation), [Year]. Draft available upon request. [Optional: \href{<link-to-draft-or-project>}{\textcolor{blue}{link}}]
	...
	% (Draft: \href{https://github.com/alibaniasad1999/master-thesis/blob/main/Paper/ZS-MARL.pdf}{\textcolor{blue}{PDF}})
...
} \hfill Oct.\ 2025 -- Present \\[2pt]
\noindent \textit{Autonomous Mobile Robot Development} \hfill Tehran, Iran
\vspace{-5pt}
\begin{itemize}   \itemsep 0pt % Slightly reduced spacing for sub-items
	...
	\item Utilized {Isaac Sim} and {PyBullet} for physics-based simulation, algorithm validation, and synthetic data generation.
\end{itemize}
...
\begin{itemize}   \itemsep 0pt % Slightly reduced spacing for sub-items
	...
	\item Built 15k LOC RL control stack (DDPG, TD3, SAC, PPO) in PyTorch/TensorFlow+Gym for embedded robots.
	\item Optimized neural networks through quantization for constrained hardware with limited CPU/memory resources.
    \item Validated robustness on Gymnasium locomotion tasks—Ant, Humanoid, HalfCheetah, Walker2d.
    \item Ported system to C++/Python ROS 2 hardware-in-the-loop node for on-board testing.
\end{itemize}
\vspace{-2pt}
...
\begin{itemize}  \itemsep 0pt % Reduce space between items
    ...
    \item Robust in-motion transfer alignment method based on multilayer neural network. \href{https://github.com/alibaniasad1999/INS-AI}{\faGithub}
\vspace{-7pt}
    \begin{itemize}\itemsep 0pt
		\item Proposed {LSTM-MLP} using only IMU + SINS data when GPS is unavailable.
    \item Cut navigation drift to $<0.1\%$ of Kalman-INS error during 100s GPS outages.
    \item Generalized across ship, ROV, and car datasets, outperforming conventional methods.
    \end{itemize}
\end{itemize}
\vspace{-2pt}
\newpage
...
\begin{itemize}  \itemsep 0pt % Slightly reduced spacing for sub-items
    ...
    \item Controlled \href{https://gcrc.sharif.edu/استند-آزمایشگاهی-کنترل-وضعیت-سه-درجه-آ/}{{3-DoF quadcopter}} using differential game and {Nash equilibrium} for robust control.
    \item Implemented controller through MATLAB/Simulink–to–C pipeline for real-time hardware.
    \item Benchmarked against {ADRC} and {DOBC}, achieving superior disturbance robustness.
\end{itemize}
...
\noindent \textit{Sharif University of Technology} \hfill Tehran, Iran \\[2pt]
\noindent Supervisors:
...
\begin{itemize}  \itemsep -2pt % Slightly reduced spacing for sub-items
    ...
    \item Implemented and validated with {Simulink} simulations and {HIL} testing using {embedded C}.
\end{itemize}
\vspace{-2pt}
...
\vspace{-5pt}
\begin{itemize}  \itemsep -2pt % Slightly reduced spacing for sub-items
    \item Implemented \href{https://link.springer.com/article/10.1007/s12652-022-04332-8}{\textcolor{blue}{REMARK}} algorithm for {multi-objective optimization} with {conflicting} objectives.
    \item Utilized {heuristic} methods to achieve high approximations of the {Pareto Set}.
\end{itemize}
\vspace{-2pt}
...
\vspace{-5pt}
\begin{itemize}  \itemsep -1pt % Slightly reduced spacing for sub-items
    \item Developed advanced {user interface} software for aircraft {stability analysis}.
...
\color{blue}{[\href{https://github.com/alibaniasad1999/CV/blob/main/attachments/PhoenixTeamModernRegionalJet.jpg}{Poster}]}
}
\hfill June 2021 \\[2pt]
\noindent \textit{Sharif University of Technology
} \hfill Tehran, Iran \\[2pt]
...
\begin{itemize}  \itemsep -1pt % Slightly reduced spacing for sub-items
	...
	\item Developed project \href{https://drive.google.com/drive/folders/1nyzjUDzIgUuoJlB1KRaJeTH69p20cMUK?usp=sharing}{\textcolor{blue}{report}} and presentation with {design choices} and simulation results.
...
\begin{itemize}  \itemsep -1pt  % enumitem
...
%     \item \textbf{Programming of C:}\vspace{-4pt}
