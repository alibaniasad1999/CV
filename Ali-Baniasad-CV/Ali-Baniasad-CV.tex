...
\begin{multicols}{2} % Start a two-column environment
    \noindent \href{https://alibaniasad1999.github.io/}{\faGlobe} Website: \href{https://alibaniasad.me/}{alibaniasad.me} \\
...
\begin{itemize} \itemsep -1pt % Reduce space between items
	...
	\item R. Pordal, A. Sharifi, and \textbf{A. BaniAsad}, "A Set-Theoretic Approach to Robust Safety Filter Synthesis," (in preparation), 2025. (Draft: \href{https://github.com/alibaniasad1999/Robust-Safety-Filter/blob/main/Report/lcsys.pdf}{\textcolor{blue}{PDF}})
\end{itemize}
...
\begin{itemize}
  ...
  \item Mentor 10 international learners in Python. % completed final project
\end{itemize}
\vspace{-4pt}
% ---------- Sharif TA ----------------------------------
