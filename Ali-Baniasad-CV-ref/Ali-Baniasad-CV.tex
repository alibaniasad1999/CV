...
\begin{itemize}   \itemsep 0pt
	\item Designed autopilot control loops with embedded RL and developed guidance/navigation algorithms with embedded ML fusing GPS/IMU data, improving trajectory tracking performance.
	\item Implemented real-time control software in C/C++ and Python with ROS\,2; conducted flight dynamics simulation using Isaac Sim and PyBullet.
	\item Applied flight mechanics and robust control to enhance autopilot stability under disturbances; participated in system integration, laboratory and field testing.
\end{itemize}
...
\vspace{-5pt}
\begin{itemize}   \itemsep 0pt
	\item Designed zero-sum, disturbance-augmented training yielding policies stable under $10\times$ perturbations; built 15k LOC RL stack (DDPG, TD3, SAC, PPO) in PyTorch/TensorFlow+Gym.
	\item Optimized neural networks via quantization for resource-constrained hardware and validated robustness on Gymnasium tasks: Ant, Humanoid, HalfCheetah, Walker2d.
...
\vspace{-5pt}
\begin{itemize}  \itemsep 0pt
	\item Led embedded AI (C) and RL projects for robotic control and navigation; developed LSTM-MLP for GPS-denied INS alignment achieving $<0.1\%$ drift vs Kalman-INS. \href{https://github.com/alibaniasad1999/INS-AI}{\faGithub}
\end{itemize}
\vspace{-2pt}
...
\vspace{-5pt}
\begin{itemize}  \itemsep 0pt
	\item Designed LQI differential-game controller outperforming ADRC/DOBC in robustness; deployed via MATLAB/Simulink-to-C pipeline for real-time 3-DoF quadcopter control.
\end{itemize}
...
\vspace{-8pt}
\begin{itemize}
    \item \textbf{Dr. Hadi Nobahari} \\
    Professor, Sharif University of Technology, Department of Aerospace Engineering \\
    Email: nobahari@sharif.ir
	\item \textbf{Dr. Mehdi Jalalmaab} \\
	Autonomous Driving \& Robotics Technical Lead, University of Waterloo \\
	Supervisor / Founder, Fasta Robotics \\
	Email: mjalalma@uwaterloo.ca
	\item \textbf{Dr. Nima Assadian} \\
    Research Associate, University of Toronto, Institute for Aerospace Studies (UTIAS) \\
    Email: nima.assadian@utoronto.ca
    % \item \textbf{Dr. Alireza Sharifi} \\
    % Assistant Professor, Sharif University of Technology, Department of Aerospace Engineering \\
    % Email: sharifi@sharif.ir
