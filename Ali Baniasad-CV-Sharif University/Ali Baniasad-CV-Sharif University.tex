...
\noindent
 \bf{M.S.}
 \normalfont{Aerospace Engineering} \hfill September 2022 -- February 2025 (Expected) \\
...
\begin{itemize} \itemsep -2pt % Reduce space between items
	\item Alireza Sharifi, \textbf{Ali BaniAsad}. "Robust In-Motion Transfer Alignment of Low-Grade Inertial Navigation Systems with Recurrent Neural Networks in the Event of Reference Malfunction." \textit{Engineering Applications of Artificial Intelligence}, 2025
	(\href{https://drive.google.com/file/d/19qd1IjmCQMv2Alldh55oYQSTPr03vjJL/view?usp=sharing}{\textcolor{blue}{Under Review}}).
...
\vspace{4pt}
\begin{itemize} \itemsep -2pt % Reduce space between items
	\item \textbf{Ali BaniAsad}, Hadi Nobahari. "Robust DDPG Reinforcement Learning Differential Game Guidance in Low-Thrust, Multi-Body Dynamical Environments" \textit{International Conference of Iranian Aerospace Society
}, 2025 (Under Review).
	\item Mahdi Amirpour, \textbf{Ali BaniAsad}, Hadi Nobahari. "Reinforcement Learning-Based Controller Design for a Suspended Ball Plant." \textit{International Conference of Iranian Aerospace Society
	}, 2025 (Under Review).
