...
\usepackage{ifthen}
\newboolean{noshad}
\setboolean{noshad}{true} % Set to false to omit the author section
\begin{document}
...
\begin{itemize} \itemsep -4pt % Slightly reduced spacing for sub-items
	...
	\item Optimized a multi-agent model for \textbf{communication delays} and \textbf{obstacle avoidance}.
...
\vspace{-8pt}
\begin{itemize} \itemsep -4pt % Slightly reduced spacing for sub-items
    \item Developed an advanced \textbf{UI} software, enhancing aircraft  \textbf{stability analysis}.
