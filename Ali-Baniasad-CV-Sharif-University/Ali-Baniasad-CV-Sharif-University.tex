...
\vspace{1pt}
    ...
    \resumeItemListStart
    \resumeItem{Alireza Sharifi, \textbf{Ali BaniAsad}. "Applied an In-Motion Transfer Alignment Approach During Global Positioning System Outages Utilizing a Recurrent Neural Network Algorithm." \textit{Engineering Applications of Artificial Intelligence}, 2025
    (\href{https://drive.google.com/file/d/19qd1IjmCQMv2Alldh55oYQSTPr03vjJL/view?usp=sharing}{\textcolor{blue}{Minor Review}}).}
     \vspace{-6pt}
...
\resumeItem{Outperformed classical MPC, cutting trajectory-tracking error by 22\%  within strict on-board CPU/memory limits.}%
    ...
    \resumeItem{Crafted zero-sum disturbance-augmented training that kept policies stable at $10\times$ worst-case perturbations.}%
\resumeItem{Validated robustness on standard Gymnasium locomotion tasks—Ant, Humanoid, HalfCheetah, and Walker2d.}%
\resumeItem{Created a ROS 2 hardware-in-the-loop node to validate RL policies on embedded hardware.}%
  ...
  \resumeItemListEnd
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Robust in-motion Transfer Alignment method based on the multilayer Neural Network.\begin{itemize}
