...
\vspace{4pt}
    ...
    \vspace{-4pt}
    \resumeItem{2025 \C \textbf{A. BaniAsad} and H. Nobahari, “Robust DDPG Reinforcement Learning Differential Game Guidance in Low-Thrust, Multi-Body Dynamical Environments,” \textit{23rd Int. Conf. of Iranian Aerospace Society} — Accepted.}
    \vspace{-4pt}
    \resumeItem{2025 \C M, Amirpour, \textbf{A. BaniAsad} and H. Nobahari, “Reinforcement Learning-Based Controller Design for a Suspended Ball Plant,” \textit{23rd Int. Conf. of Iranian Aerospace Society} — Accepted.}
    \vspace{-4pt}
