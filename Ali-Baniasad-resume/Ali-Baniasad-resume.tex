...
\vspace{4pt}
    ...
    \resumeItemListStart
    % \justifying
    \resumeItem{2025 \J A. Sharifi, \textbf{A. BaniAsad}, \etal\ “Applied an In-Motion Transfer Alignment Approach During Global Positioning System Outages Utilizing a Recurrent Neural Network Algorithm,” \textit{Eng.\ Appl.\ AI} — \href{https://github.com/alibaniasad1999/INS_AI/blob/main/Report/revised.pdf}{\textcolor{blue}{Completed - Accept}}.}
    \vspace{-16pt}
